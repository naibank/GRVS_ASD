...
snv.rare <- fread("../data/SNVs/calls/denovo/all.denovo.variants.OCT2019.tsv")
...
### DeepSEA
deepsea1 <- read.delim("../dataNC/DeepSEA.tier1.denovo.tsv", stringsAsFactors = F)[, 1:6]
deepsea2 <- read.delim("../dataNC/DeepSEA.tier2.denovo.tsv", stringsAsFactors = F)[, 1:6]
...
gerp.annovar <- read.delim("../dataNC/denovo_with_gerp.csv", sep=",", stringsAsFactors = F)
...
write.table(snv.rare, "../dataNC/snv.denovo.annotated.tsv", sep="\t", row.names=F, quote=F, col.names=T)
