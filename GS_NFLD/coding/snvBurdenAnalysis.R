...
write.table(snv.matrix, "rare.coding.snv.tsv", sep="\t", row.names=F, quote=F, col.names=T)

#writeLines(as.character(unique(snv.matrix$sample)), "samples.in.rae.snv.analysis.tsv")
